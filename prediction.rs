...
impl Predictor {
	...
	type fn_predict_type = unsafe extern "C" fn(*mut u8, *const u8, *const u8, u64, u64);

        let accelerated_implementation = match (self, color_depth, stride) {
            (Predictor::None, 32, 4) => Some(parng_predict_scanline_none_packed_32bpp as fn_predict_type),
            (Predictor::None, 32, _) => Some(parng_predict_scanline_none_strided_32bpp as fn_predict_type),
            (Predictor::None, 24, 4) => Some(parng_predict_scanline_none_packed_24bpp as fn_predict_type),
            (Predictor::None, 24, _) => Some(parng_predict_scanline_none_strided_24bpp as fn_predict_type),
            (Predictor::None, 16, 4) => Some(parng_predict_scanline_none_packed_16bpp as fn_predict_type),
            (Predictor::None, 16, _) => None,
            (Predictor::None, 8, 4) => Some(parng_predict_scanline_none_packed_8bpp as fn_predict_type),
            (Predictor::None, 8, _) => None,
            (Predictor::Left, 32, 4) => Some(parng_predict_scanline_left_packed_32bpp as fn_predict_type),
            (Predictor::Left, 32, _) => Some(parng_predict_scanline_left_strided_32bpp as fn_predict_type),
            (Predictor::Left, 24, 4) => Some(parng_predict_scanline_left_packed_24bpp as fn_predict_type),
            (Predictor::Left, 24, _) => Some(parng_predict_scanline_left_strided_24bpp as fn_predict_type),
            (Predictor::Left, 16, 4) => Some(parng_predict_scanline_left_packed_16bpp as fn_predict_type),
            (Predictor::Left, 16, _) => None,
            (Predictor::Left, 8, 4) => Some(parng_predict_scanline_left_packed_8bpp as fn_predict_type),
            (Predictor::Left, 8, _) => None,
            (Predictor::Up, 32, 4) => Some(parng_predict_scanline_up_packed_32bpp as fn_predict_type),
            (Predictor::Up, 32, _) => Some(parng_predict_scanline_up_strided_32bpp as fn_predict_type),
            (Predictor::Up, 24, 4) => Some(parng_predict_scanline_up_packed_24bpp as fn_predict_type),
            (Predictor::Up, 24, _) => Some(parng_predict_scanline_up_strided_24bpp as fn_predict_type),
            (Predictor::Up, 16, 4) => Some(parng_predict_scanline_up_packed_16bpp as fn_predict_type),
            (Predictor::Up, 16, _) => None,
            (Predictor::Up, 8, 4) => Some(parng_predict_scanline_up_packed_8bpp as fn_predict_type),
            (Predictor::Up, 8, _) => None,
            (Predictor::Average, 32, _) => Some(parng_predict_scanline_average_strided_32bpp as fn_predict_type),
            (Predictor::Average, 24, _) => Some(parng_predict_scanline_average_strided_24bpp as fn_predict_type),
            (Predictor::Average, 16, _) => None,
            (Predictor::Average, 8, _) => None,
            (Predictor::Paeth, 32, _) => Some(parng_predict_scanline_paeth_strided_32bpp as fn_predict_type),
            (Predictor::Paeth, 24, _) => Some(parng_predict_scanline_paeth_strided_24bpp as fn_predict_type),
