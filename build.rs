...
#[cfg(target_arch = "x86_64")]
static PREDICTION_SOURCE: &'static str = "src/asm/prediction-x86_64-avx.asm";
#[cfg(target_arch = "arm")]
static PREDICTION_OBJ: &'static str = "prediction-arm-neon.o";
#[cfg(target_arch = "arm")]
static PREDICTION_SOURCE: &'static str = "src/asm/prediction-arm-neon.asm";

#[cfg(all(target_arch = "x86_64", target_os = "windows"))]
fn assemble(out_path: &str, in_path: &str) {
    Command::new(&format!("nasm"))
        .arg("-f")
        .arg("win64")
        .arg("-o")
        .arg(out_path)
...
fn assemble(out_path: &str, in_path: &str) {
    ...
    Command::new(&format!("cpp"))
        .arg("-o")
        .arg(&temp_path)
        .arg(in_path)
        .status()
        .unwrap();
    Command::new(&format!("as"))
        .arg("-o")
        .arg(out_path)
        .arg("-mfpu=neon")
        .arg(temp_path)
...
fn main() {
    ...
    Build::new()
        .object(&predict_o)
        .compile("libparngacceleration.a")
}
